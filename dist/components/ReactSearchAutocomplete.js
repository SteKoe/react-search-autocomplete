...
function ReactSearchAutocomplete(_a) {
    var _b = _a.items, items = _b === void 0 ? [] : _b, _c = _a.fuseOptions, fuseOptions = _c === void 0 ? config_1.defaultFuseOptions : _c, _d = _a.inputDebounce, inputDebounce = _d === void 0 ? exports.DEFAULT_INPUT_DEBOUNCE : _d, _e = _a.onSearch, onSearch = _e === void 0 ? function () {
    } : _e, _f = _a.onHover, onHover = _f === void 0 ? function () {
    ...
    } : _j, _k = _a.showIcon, showIcon = _k === void 0 ? true : _k, _l = _a.showClear, showClear = _l === void 0 ? true : _l, _m = _a.maxResults, maxResults = _m === void 0 ? exports.MAX_RESULTS : _m, _o = _a.placeholder, placeholder = _o === void 0 ? '' : _o, _p = _a.autoFocus, autoFocus = _p === void 0 ? false : _p, _q = _a.styling, styling = _q === void 0 ? {} : _q, _r = _a.resultStringKeyName, resultStringKeyName = _r === void 0 ? 'name' : _r, _s = _a.updateResultsOnInputChange, updateResultsOnInputChange = _s === void 0 ? true : _s, _t = _a.inputSearchString, inputSearchString = _t === void 0 ? '' : _t, formatResult = _a.formatResult, _u = _a.showNoResults, showNoResults = _u === void 0 ? true : _u, _v = _a.showNoResultsText, showNoResultsText = _v === void 0 ? 'No results' : _v, _w = _a.showItemsOnFocus, showItemsOnFocus = _w === void 0 ? false : _w, _x = _a.maxLength, maxLength = _x === void 0 ? 0 : _x, className = _a.className;
    ...
    (0, react_1.useEffect)(function () {
        ...
        if (updateResultsOnInputChange) {
            var timeoutId_1 = setTimeout(function () { return setResults(fuseResults(inputSearchString)); }, 0);
